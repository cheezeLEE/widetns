...
<body>
  ...
  비고 : ...
      ...
      <div class="btnArea col-sm-9">
        <button class="btn btn-primary btn-sm" id="addBtn">추가</button>
        <button class="btn btn-danger btn-sm" id="delBtn">삭제</button>
      </div>
      <table>
        <thead>
          <tr>
  ...
  <script>
    $(document).ready(function () {
      ...
      //비동기 방식, 페이지 이동을 하면 안되지만 아직 초안이라서 이렇게 작성..ㅎ
